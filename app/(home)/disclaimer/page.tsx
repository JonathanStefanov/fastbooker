    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          ...
          <p className="text-gray-700"><strong>FastBooker is an independent, unofficial project and is NOT affiliated with, endorsed by, or connected to Affluences in any way.</strong></p>
          <p className="text-gray-700">This application was created through reverse-engineering of the Affluences API for educational purposes and to demonstrate improved user experience design.</p>
        </section>
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-gray-800">Use at Your Own Risk</h2>
          <p className="text-gray-700">By using FastBooker, you acknowledge and accept the following risks:</p>
        ...
        <section>
          ...
          <p className="text-gray-700"><strong>For Affluences Representatives:</strong> If you have concerns about this project, please contact the repository owner through{' '}<a href="https://github.com/JonathanStefanov/fastbooker/issues" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">GitHub issues</a>. We will respond promptly and cooperatively.</p>
          <p className="text-gray-700 mt-2"><strong>For Users:</strong> If you have questions or concerns, please open an issue on GitHub.</p>
        </section>
        <section className="bg-gray-50 p-4 rounded-lg border border-gray-200">
          <h2 className="text-2xl font-semibold mb-3 text-gray-800">No Warranty</h2>
          <p className="text-gray-600 text-sm">THE SOFTWARE IS PROVIDED &quot;AS IS&quot;, WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT. IN NO EVENT SHALL THE AUTHORS OR COPYRIGHT HOLDERS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.</p>
        </section>
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-500 text-center">Last Updated: January 2026</p>
          <div className="flex justify-center gap-4 mt-4">
            <a href="/" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">Back to Home</a>
            <a href="https://affluences.com" target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 transition-colors">Visit Official Affluences</a>
          </div>
        </div>
      </div>
    </div>
