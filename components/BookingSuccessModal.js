...
function Confetti() {
  const particles = Array.from({ length: 24 }, (_, i) => ({
    ...
    shape: i % 3, // 0 = circle, 1 = square, 2 = line
  }));
      ...
      {particles.map((p) => (
        <motion.div
          ...
          style={{
            ...
            borderRadius: p.shape === 0 ? '50%' : p.shape === 2 ? '2px' : '2px',
...
export default function BookingSuccessModal({ open, onClose, seatName, startTime, endTime, date }) {
